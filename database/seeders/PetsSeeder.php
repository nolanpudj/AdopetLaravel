    ...
    public function run()
    {
        ...
        for ($i = 1; $i < 10; $i++) {
            DB::table('pets')->insert([
                ...
                'petDesc'       => 'A delightful pet with a heart full of love, always ready to brighten your day with playful antics and affectionate cuddles.',
        ...
        for ($i = 1; $i < 10; $i++) {
            DB::table('pets')->insert([
                ...
                'petDesc'       => 'A loyal friend with a soft coat and warm eyes, offering comfort and companionship through thick and thin.',
        ...
        for ($i = 1; $i < 10; $i++) {
            DB::table('pets')->insert([
                ...
                'petDesc'       => 'A colorful and chirpy companion that adds a touch of joy to your home, making every day a song-filled adventure.',
        ...
        for ($i = 1; $i < 10; $i++) {
            DB::table('pets')->insert([
                ...
                'petDesc'       => 'An elegant and graceful pet that moves with poise, adding a touch of sophistication to your home',
        ...
        for ($i = 1; $i < 10; $i++) {
            DB::table('pets')->insert([
                ...
                'petDesc'       => 'A unique and quirky friend with a personality that never fails to surprise and bring laughter into your life.',
